...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        while(true)
        {
            ...
            System.out.println("6.Extragerea din lista de angajați a unei liste de String-uri care conține numele angajaților \n" +
                    "scrise cu majuscule");
            ...
            switch(opt)
            {
                ...
                case 6: {
                    System.out.println("extragere angajati care incep cu majuscula");
